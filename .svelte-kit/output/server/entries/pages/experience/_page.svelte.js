...
/* empty css                                                   */import { t as title, i as items } from "../../../chunks/experience.js";
...
const ExperienceCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const to = experience.period.to ? `${getMonthName(experience.period.to.getMonth())} ${experience.period.to.getFullYear()}` : "Presente";
