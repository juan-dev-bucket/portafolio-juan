...
const CommonPage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.classe === void 0 && $$bindings.classe && classe !== void 0)
    $$bindings.classe(classe);
  let $$settled;
  let $$rendered;
  ...
  do {
    ...
    $$rendered = `${validate_component(TabTitle, "TabTitle").$$render(
      ...
      {}
    )} <div class="flex-1 col gap-5 px-2 sm:px-4 md:px-6 py-4 sm:py-8 md:py-12">${validate_component(MainTitle, "MainTitle").$$render($$result, { classes: classe }, {}, {
      default: () => {
        return `${escape(title)}`;
      }
