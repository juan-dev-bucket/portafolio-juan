...
const items = [
  ...
  },
  {
    slug: "contable",
    color: "#5e95e3",
    description: "Es la herramienta definitiva para llevar un control claro, sencillo y efectivo de tus finanzas personales. Diseñada para facilitarte el manejo de tu dinero, esta aplicación te permite monitorear tus ingresos, gastos y ahorrar de manera eficiente, todo desde la palma de tu mano.",
    shortDescription: "Es la herramienta definitiva para llevar un control claro, sencillo y efectivo de tus finanzas personales. Diseñada para facilitarte el manejo de tu dinero, esta aplicación te permite monitorear tus ingresos, gastos y ahorrar de manera eficiente, todo desde la palma de tu mano.<br> Pronto....",
